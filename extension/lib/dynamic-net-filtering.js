...
var domainFromHostname = pm.URI.domainFromHostname;
...
Matrix.prototype.fromString = function(text, append) {
    var lineIter = new pm.LineIterator(text),
        line, pos, fields,
...
pm.sessionFirewall = new pm.Firewall();
pm.permanentFirewall = new pm.Firewall();
