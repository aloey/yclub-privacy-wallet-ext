...
/******************************************************************************/
// TODO: get switch status
pm.getNetFilteringSwitch = function(url) {
...
/******************************************************************************/
// TODO: onSwitchClicked
pm.toggleNetFilteringSwitch = function(url, scope, newState) {
...
pm.stringFromWhitelist = function(whitelist) {
    var r = {};
    var i, bucket;
...
pm.whitelistFromString = function(s) {
...
pm.validateWhitelistString = function(s) {
...
pm.changeUserSettings = function(name, value) {
...
pm.elementPickerExec = function(tabId, targetElement, zap) {
...
pm.toggleFirewallRule = function(details) {
...
pm.toggleURLFilteringRule = function(details) {
...
pm.toggleHostnameSwitch = function(details) {
...
pm.logCosmeticFilters = (function() {
    var tabIdToTimerMap = {};

    var injectNow = function(tabId) {
        delete tabIdToTimerMap[tabId];
        pm.scriptlets.injectDeep(tabId, 'cosmetic-logger');
    };
