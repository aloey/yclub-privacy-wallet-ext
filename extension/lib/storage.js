...
pm.getBytesInUse = function(callback) {
    if ( typeof callback !== 'function' ) {
        callback = this.noopFunc;
    }
    var getBytesInUseHandler = function(bytesInUse) {
        pm.storageUsed = bytesInUse;
        callback(bytesInUse);
    };
...
pm.keyvalSetOne = function(key, val, callback) {
    var bin = {};
    bin[key] = val;
...
pm.hiddenSettingsFromString = function(raw) {
...
pm.stringFromHiddenSettings = function() {
    var out = [],
...
pm.loadSelectedFilterLists = function(callback) {
    var µb = this;
...
pm.saveSelectedFilterLists = function(newKeys, append, callback) {
...
pm.applyFilterListSelection = function(details, callback) {
    var µb = this,
...
pm.listKeysFromCustomFilterLists = function(raw) {
    var out = new Set(),
        reIgnore = /^[!#]/,
        reValid = /^[a-z-]+:\/\/\S+/,
        lineIter = new this.LineIterator(raw),
...
pm.saveUserFilters = function(content, callback) {
...
pm.loadUserFilters = function(callback) {
    return this.assets.get(this.userFiltersPath, callback);
};

/******************************************************************************/

pm.appendUserFilters = function(filters) {
...
pm.autoSelectRegionalFilterLists = function(lists) {
...
pm.getAvailableLists = function(callback) {
    var µb = this,
        oldAvailableLists = {},
        newAvailableLists = {};
...
pm.loadingFilterLists = false;

pm.loadFilterLists = function(callback) {
    ...
    console.log('storage.loadFilterLists.main');
    console.log(µb.availableFilterLists);
...
pm.getCompiledFilterList = function(assetKey, callback) {
    var µb = this,
...
pm.extractFilterListMetadata = function(assetKey, raw) {
...
pm.removeCompiledFilterList = function(assetKey) {
    this.assets.remove('compiled/' + assetKey);
};

pm.removeFilterList = function(assetKey) {
...
pm.compileFilters = function(rawText) {
...
pm.applyCompiledFilters = function(rawText, firstparty) {
    if ( rawText === '' ) { return; }
    var separator = '\n/* end of network - start of cosmetic */\n',
...
pm.loadRedirectResources = function(callback) {
    var µb = this,
        content = '';
...
pm.loadPublicSuffixList = function(callback) {
    var µb = this,
...
pm.compilePublicSuffixList = function(content) {
...
pm.restoreAdminSettings = function(callback) {
...
pm.listMatchesEnvironment = function(details) {
    var re;
    // Matches language?
...
pm.scheduleAssetUpdater = (function() {
    var timer, next = 0;
...
pm.assetObserver = function(topic, details) {
